 ...
 *****************************************************************************************
 *      Miscellaneous utility functions and commands for various game operations         *
 ****************************************************************************************/
#include <sys/types.h>
#include <stdio.h>
#include <string.h>
...
CMDF do_buyhome(CharData * ch, char *argument)
{
        ...
        if (!IsSet(room->RoomFlags, RoomEmptyHome))
        {
        ...
        RemoveBit(room->RoomFlags, RoomEmptyHome);
        SetBit(room->RoomFlags, RoomPlrHome);
...
CMDF do_sellhome(CharData * ch, char *argument)
{
        ...
        if (IsSet(room->RoomFlags, RoomPlrHome))
        {
...
CMDF do_hail(CharData * ch, char *argument)
{
        ...
        if (IsSet(ch->in_room->RoomFlags, RoomSpacecraft))
        {
             ...
             vnum <= ch->in_room->area->hi_r_vnum; vnum++)
        {
                ...
                if (room != NULL)
                {
                        if (IsSet(room->RoomFlags, RoomPlrHome))
                                continue;
                        else if (IsSet(room->RoomFlags, RoomEmptyHome))
                                continue;
                        else if (IsSet(room->RoomFlags, RoomNoHailTo))
                                continue;
                        else if (IsSet(room->RoomFlags, type))
                                break;
                }
                /*
